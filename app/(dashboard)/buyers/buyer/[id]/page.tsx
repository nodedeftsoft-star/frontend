...
export default function BuyerDetails() {
  ...
  const tabType = searchParams.get("t") || "buyerinfo";
  ...
  const {
    ...
    queryKey: ["buyer", id],
    queryFn: () => fetchBuyer(id as string),
    enabled: !!id,
    // Use cached data immediately for instant display
    initialData: () => {
      return queryClient.getQueryData(["buyer", id]);
    },
      ...
      <div className="flex justify-between  px-2 mb-4">
        ...
        <div className="flex gap-2 pr-12">
          ...
          <FormSheet
            ...
            onSuccess={handleEditBuyerSuccess}
            icon
          >
            <EditBuyerForm Buyer={buyer as Buyer} onSuccess={handleEditBuyerSuccess} />
          </FormSheet>
                ...
                <div className="border border-[#E5E8EB] w-full flex flex-col rounded-lg p-6 mb-4">
                  ...
                  <div className="flex flex-col gap-4">
                    {[
                      ...
                      { label: "Swimming Pool", value: buyer?.amenities.includes("swimmingPool") ? "Yes" : "No" },
                  ...
                  <div>
                    <ScrollArea className="h-[325px] w-full">
                      <div className="pb-6 mx-1">
                        {buyer?.activityNotes.map((item, index) => (
