...
interface EditListingRentalsFormProps {
  listing: Listing;
  onSuccess?: () => void;
}

export default function EditListingRentalsForm({ onSuccess, listing }: EditListingRentalsFormProps) {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      isVoucherApproved: listing?.isVoucherApproved || false,
    },
  });
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    try {
      ...
      queryClient.invalidateQueries({ queryKey: ["listing-rental", listing._id] });
  ...
  return (
    <div className="space-y-6 w-full mx-auto p-6 py-0 relative">
      ...
      <div className="fixed bottom-0 z-50 bg-white w-full p-6 border-t border-gray-200">
        <Button
          type="submit"
          form="edit-listings-rentals-form"
