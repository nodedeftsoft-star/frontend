...
export async function POST(req: NextRequest) {
  try {
    ...
    const leadsSellerData: LeadsSeller[] = body;

    //console.log("LEADS seller DATA:", leadsSellerData);

    const response = await api.post("/leads/sellers/fast-bulk-add", leadsSellerData, {
      headers: {
    ...
    console.error("Error adding leads seller:", error);
